...
module "instance_1" {
  ...
  root_volume_size  = 8 # increasing volume from 8 --> 16 GB
...
module "application_load_balancer" {
  ...
  internal      = false
  lb_type       = "application"
  instance_1_id = module.instance_1.instance_ids
  # instance_1_id = module.instance_1.instance_ids
  instance_2_id = module.instance_2.instance_ids
}
...
module "asg" {
  ...
  lba             = module.application_load_balancer.tg_arn
}
